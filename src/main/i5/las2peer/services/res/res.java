...
public class res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "MetadataTest5", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "dev", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/CAE-Community-Application-Editor/microservice-MetadataTest5/blob/master/LICENSE.txt") ) )
  @Path("/")
